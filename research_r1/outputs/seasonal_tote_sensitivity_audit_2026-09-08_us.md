...
| 2026-09-08 / small | 2 | 3 | 7050 | 3900 | blocked | blocked | `not_computed` | `sensitivity_context_only` |
...
- 2026-09-08：Dior 已补到 3 个不同家族配置，但 Chanel 季节小号 Tote 仍只有 2 个；Dior 的常规/季节状态仍为 `not_disclosed`。
- Mini 行单独隔离，不与 small Tote 配对。

## 结论

本轮没有任何可发布的季节对季节价格差。2026-09-08 的 Dior 样本量门槛已达到，但状态门槛和 Chanel 样本量门槛仍未达到；当前输出只能作为敏感性路线的描述性背景。
