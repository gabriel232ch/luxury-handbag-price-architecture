...
结果：共 45 个属性单元，17 条 Chanel-竞品候选配对，1 个单元通过主文门槛。

配对状态计数：`{'blocked_unknown_size': 11, 'blocked_no_chanel_subject': 25, 'blocked_no_cross_brand_peer': 2, 'blocked_sample_insufficient': 2, 'blocked_woc_sensitivity_only': 1, 'same_date_exact_attributes': 1, 'blocked_unknown_bag_type': 3}`。
