...
下一阶段需要取得更多同日期、同包型、同尺寸、同材质的独立配置，并明确常规/季节状态。2026-09-08 的两边样本量均已达到 3 个独立配置，但 Dior 官方详情页未披露常规/季节状态；本路线因此正式收口为描述性敏感性背景。只有后续官方来源明确给出状态标签，才重新考虑发布季节敏感性统计。
...
- [Dior 状态核验](../data/dior_status_verification_2026-09-08_us.md)
